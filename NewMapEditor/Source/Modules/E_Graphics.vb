...
Module E_Graphics
    ...
    Sub InitGraphics()
        ...
        TilesetWindow = New RenderWindow(FrmMapEditor.PicTileset.Handle)
    ...
    Friend Sub Render_Graphics()
        ...
        TilesetWindow.SetView(New View(New FloatRect(0, 0, FrmMapEditor.PicTileset.Width, FrmMapEditor.PicTileset.Height)))
    ...
    Friend Sub EditorMap_DrawTileset()
        ...
        FrmMapEditor.PicTileset.Height = height
        FrmMapEditor.PicTileset.Width = width
