...
#Region "Incoming Packets"
    ...
    Sub Packet_SavePet(index As Integer, ByRef data() As Byte)
        ...
        ' Prevent hacking
        If petNum < 0 OrElse petNum > MAX_PETS Then Return
    ...
    Sub Packet_UsePetStatPoint(index As Integer, ByRef data() As Byte)
        ...
        ' Prevent hacking
        If (pointType < 0) OrElse (pointType > StatType.Count) Then Return

        If Not PetAlive(index) Then Return
...
#Region "Pet Functions"
    ...
    Sub PetDir(index As Integer, dir As Integer)
        ...
        If index <= 0 OrElse index > MAX_PLAYERS OrElse dir < DirectionType.Up OrElse dir > DirectionType.Right Then Return

        If TempPlayer(index).PetskillBuffer.Skill > 0 Then Return
    ...
    Friend Sub PetFireProjectile(index As Integer, spellnum As Integer)
        ...
        If spellnum < 1 OrElse spellnum > MAX_SKILLS Then Return
...
#Region "Npc > Pet"
    ...
    Sub NpcAttackPet(mapnpcnum As Integer, victim As Integer, damage As Integer)
        ...
        ' Check for subscript out of range
        If MapNpc(GetPlayerMap(victim)).Npc(mapnpcnum).Num <= 0 Then Return
...
#Region "Pet > Player"
    ...
    Friend Sub TryPetAttackPlayer(index As Integer, victim As Integer)
        ...
        If GetPlayerMap(index) <> GetPlayerMap(victim) Then Return
...
#Region "Pet > Pet"
    ...
    Friend Sub TryPetAttackPet(index As Integer, victim As Integer)
        ...
        If Not PetAlive(index) OrElse Not PetAlive(victim) Then Return
...
#Region "Skills"
    ...
    Friend Sub BufferPetSkill(index As Integer, skillSlot As Integer)
        ...
        If skillSlot <= 0 OrElse skillSlot > 4 Then Return
...
#Region "Player > Pet"
    ...
    Sub PlayerAttackPet(attacker As Integer, victim As Integer, damage As Integer, Optional skillnum As Integer = 0)
        ...
        If IsPlaying(attacker) = False OrElse IsPlaying(victim) = False OrElse damage < 0 OrElse Not PetAlive(victim) Then Return
    ...
    Friend Sub TryPlayerAttackPet(attacker As Integer, victim As Integer)
        ...
        If Not PetAlive(victim) Then Return
...
#Region "Data Functions"
    ...
    Sub SetPetVital(index As Integer, vital As VitalType, amount As Integer)
        ...
        If index > MAX_PLAYERS Then Return
