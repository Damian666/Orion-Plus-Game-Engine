...
Module modLoop
    ...
    Private Sub UpdateNpcAi()
        ...
        For mapNum = 1 To MAX_CACHED_MAPS
            ...
            If ServerDestroyed Then Return
            ...
            If ResourceCache Is Nothing Then Return
    ...
    Friend Sub CastSkill(index As Integer, skillSlot As Integer)
        ...
        ' Preventative checks
        If Not IsPlaying(index) OrElse skillSlot <= 0 OrElse skillSlot > MAX_PLAYER_SKILLS OrElse Not HasSkill(index, skillId) Then Return
    ...
    Friend Sub CastNpcSkill(npcNum As Integer, mapNum As Integer, skillslot As Integer)
        ...
        If MapNpc(mapNum).Npc(npcNum).Vital(modEnumerators.VitalType.MP) < mpCost Then Return
        ...
        Select Case skillCastType
            ...
            Case 2 ' targetted
                ...
                If targetType = 0 OrElse target = 0 Then Return
                ...
                If Not IsInRange(range, MapNpc(mapNum).Npc(npcNum).X, MapNpc(mapNum).Npc(npcNum).Y, x, y) Then Return
    ...
    Friend Sub SkillNpc_Effect(vital As Byte, increment As Boolean, index As Integer, damage As Integer, skillnum As Integer, mapNum As Integer)
        ...
        If index <= 0 OrElse index > MAX_MAP_NPCS OrElse damage < 0 OrElse MapNpc(mapNum).Npc(index).Vital(vital) <= 0 Then Return
