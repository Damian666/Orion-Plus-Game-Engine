...
#Region "Maps"
    ...
    Sub LoadMapEvent(mapNum As Integer)
        ...
        If Not Map(mapNum).EventCount > 0 Then Return
...
#Region "Bank"
    ...
    Friend Sub LoadBank(index As Integer, Name As String)
        ...
        For i = 1 To MAX_BANK
            Bank(index).Item(i).Index = reader.ReadByte()
            Bank(index).Item(i).Amount = reader.ReadInt32()
    ...
    Sub SaveBank(index As Integer)
        ...
        For i = 1 To MAX_BANK
            writer.WriteByte(Bank(index).Item(i).Index)
            writer.WriteInt32(Bank(index).Item(i).Amount)
    ...
    Sub ClearBank(index As Integer)
        ...
        For i = 1 To MAX_BANK
            ...
            Bank(index).Item(i).Index = 0
            Bank(index).Item(i).Amount = 0
...
#Region "Characters"
    ...
    Sub ClearCharacter(index As Integer, CharNum As Integer)
        ...
        For i = 0 To MAX_INV
            Player(index).Character(CharNum).Inv(i).Index = 0
            Player(index).Character(CharNum).Inv(i).Amount = 0
        Next
    ...
    Sub LoadCharacter(index As Integer, CharNum As Integer)
        ...
        For i = 0 To MAX_INV
            Player(index).Character(CharNum).Inv(i).Index = reader.ReadByte()
            Player(index).Character(CharNum).Inv(i).Amount = reader.ReadInt32()
        Next
    ...
    Sub SaveCharacter(index As Integer, CharNum As Integer)
        ...
        For i = 0 To MAX_INV
            writer.WriteByte(Player(index).Character(CharNum).Inv(i).Index)
            writer.WriteInt32(Player(index).Character(CharNum).Inv(i).Amount)
        Next
        ...
        If Len(Trim$(Player(index).Character(CharNum).Name)) = 0 Then
            ...
            For n = 1 To 5
                If Classes(ClassNum).StartItem(n) > 0 Then
                    Player(index).Character(CharNum).Inv(n).Index = Classes(ClassNum).StartItem(n)
                    Player(index).Character(CharNum).Inv(n).Amount = Classes(ClassNum).StartValue(n)
