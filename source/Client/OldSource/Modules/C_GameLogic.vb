...
Module C_GameLogic
        ...
        Do
            ...
            If GameStarted() = True Then
                ...
                If tmr100 < tick Then
                    ...
                    'TODO:  If InBank Then DrawBank()
                    'TODO:  If InShop Then DrawShop()
                    'TODO:  If InTrade Then DrawTrade()
    ...
    Friend Function IsInBounds()
        Dim pos = CurPos
        Return pos.X >= 0 AndAlso
               pos.X <= Map.MaxX AndAlso
               pos.Y >= 0 AndAlso
               pos.Y <= Map.MaxY
    End Function
...
Continue1:
    ...
    Friend Sub UpdateDescWindow(itemnum As Integer, amount As Integer, invNum As Integer, windowType As Byte)
        ...
        If LastItemDesc = itemnum Then Return

        ' set the name
        'TODO: ItemDescRarityColor = Graphics.ItemRarityColor(tmpRarity)
    ...
    Friend Sub UpdateSkillWindow(skillnum As Integer)
        ...
        If LastSkillDesc = skillnum Then Return
