...
#End Region
    ...
    Sub UpdateUi()
        ...
        If ShowRClick = True Then
            ...
            Graphics.MenuPosition.X = Graphics.MapPositionX(CurPos.X * PicX)
            Graphics.MenuPosition.Y = Graphics.MapPositionY(CurPos.Y * PicY)
        ...
        If InitEventEditorForm = True Then
            ...
            With FrmEditor_Events
                ...
                Dim numfaces = UBound(Graphics.Faces)
