...
#End Region
    ...
    Friend Sub CacheRenderState(x As Integer, y As Integer, layerNum As Integer)
        ...
        With Map.Tile(x, y)
            ...
            'TODO:  If .Layer(layerNum).Tileset <= 0 OrElse .Layer(layerNum).Tileset > NumTileSets Then
            'TODO:   Autotile(x, y).Layer(layerNum).RenderState = RenderStateNone
            'TODO:   Return
            'TODO:  End If
    ...
    Friend Sub CalculateAutotile(x As Integer, y As Integer, layerNum As Integer)
        ...
        If Map.Tile(x, y).Layer(layerNum).AutoTile = 0 Then Return
    ...
    Friend Sub DrawAutoTile(layerNum As Integer, destPosition As Vector2f, quarterNum As Integer, x As Integer, y As Integer, Optional forceFrame As Integer = 0, Optional strict As Boolean = True)
        ...
        'TODO:  RenderSprite(TileSetSprite(Map.Tile(x, y).Layer(layerNum).Tileset), GameWindow, destX, destY, Autotile(x, y).Layer(layerNum).SrcX(quarterNum) + xOffset, Autotile(x, y).Layer(layerNum).SrcY(quarterNum) + yOffset, 16, 16)
    End Sub
