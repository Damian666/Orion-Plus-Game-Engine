...
#Region "Drawing"
    ...
    Friend Sub DrawAnimation(index As Integer, layer As Integer)
        ...
        If sprite < 1 OrElse sprite > NumAnimations Then Return
        ...
        If sRect.Width < 0 OrElse sRect.Height < 0 Then Return
    ...
    Friend Sub CheckAnimInstance(index As Integer)
        ...
        If AnimInstance(index).Animation <= 0 Then Return
        If AnimInstance(index).Animation >= MAX_ANIMATIONS Then Return
