...
#Region "Drawing"
    ...
    Friend Sub DrawPet(index As Integer)
        ...
        If sprite < 1 OrElse sprite > NumCharacters Then Return
    ...
    Sub DrawPetBar()
        ...
        If Not HasPet(Myindex) Then Return
    ...
    Sub DrawPetStats()
        ...
        If Not ShowPetStats Then Return
...
#Region "Editor"
    ...
    Friend Sub PetEditorInit()
        ...
        If frmEditor_Pet.Visible = False Then Return
