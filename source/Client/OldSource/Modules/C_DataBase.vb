...
#Region "Assets Check"
    ...
    Friend Sub CheckCharacters()
        ...
        If NumCharacters = 0 Then Return
    End Sub
    ...
    Friend Sub CheckPaperdolls()
        ...
        If NumPaperdolls = 0 Then Return
    End Sub
    ...
    Friend Sub CheckAnimations()
        ...
        If NumAnimations = 0 Then Return
    End Sub
    ...
    Friend Sub CheckSkillIcons()
        ...
        If NumSkillIcons = 0 Then Return
    End Sub
