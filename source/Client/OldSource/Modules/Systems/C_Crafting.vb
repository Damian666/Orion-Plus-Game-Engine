...
#Region "OutGoing Packets"
    ...
    Friend Sub SendCraftIt(recipeName As String, amount As Integer)
        ...
        If recipeindex <= 0 Then Return

        'check,check, double check

        'we dont even know the damn recipe xD
        If Player(Myindex).RecipeLearned(recipeindex) = 0 Then Return
...
#Region "Editor"
    ...
    Friend Sub RecipeEditorInit()
        ...
        If frmEditor_Recipe.Visible = False Then Return
...
#Region "Functions"
    ...
    Friend Sub DrawCraftPanel()
        ...
        If SelectedRecipe = 0 Then Return
