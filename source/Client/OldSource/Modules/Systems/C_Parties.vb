...
#Region "Incoming Packets"
    ...
    Sub Packet_PartyVitals(ByRef data() As Byte)
        ...
        If partyindex <= 0 OrElse partyindex > MAX_PARTY_MEMBERS Then Return
...
#Region "Drawing"
    ...
    Friend Sub DrawParty()
        ...
        If Party.Leader > 0 Then ' make sure we're in a party
            ...
            y = 100
            x = 10
            DrawText(x, y, theName, SFML.Graphics.Color.Yellow, SFML.Graphics.Color.Black)
            ...
            If Player(playerNum).Vital(VitalType.HP) > 0 Then
                ...
                'TODO: GameWindow.Draw(rectShape)
            End If
            ' draw mp
            If Player(playerNum).Vital(VitalType.MP) > 0 Then
                ...
                'TODO: GameWindow.Draw(rectShape2)
            End If
            ...
            For I = 1 To MAX_PARTY_MEMBERS
                If Party.Member(I) > 0 Then
                    If Party.Member(I) <> Party.Leader Then
                        ...
                        DrawText(x, y, theName, SFML.Graphics.Color.White, SFML.Graphics.Color.Black)
                        ' draw hp
                        y = 115 + ((I - 1) * 30)
