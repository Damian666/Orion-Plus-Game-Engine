...
#Region "Drawing"
    ...
    Friend Sub DrawFog()
        ...
        fogNum = CurrentFog
        If fogNum <= 0 OrElse fogNum > NumFogs Then Return
...
#Region "Sound"
    ...
    Sub PlayWeatherSound(fileName As String, Optional looped As Boolean = False)
        If Not Settings.Sound = 1 OrElse Not File.Exists(Path.Sounds & fileName) Then Return
        If CurWeatherMusic = fileName Then Return
    ...
    Sub StopWeatherSound()
        If WeatherSoundPlayer Is Nothing Then Return
