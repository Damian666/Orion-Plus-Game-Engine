...
#Region "Animation Editor"
    ...
    Friend Sub AnimationEditorInit()
        ...
        If FrmEditor_Animation.Visible = False Then Return
...
#Region "Npc Editor"
    ...
    Friend Sub NpcEditorInit()
        ...
        If frmEditor_NPC.Visible = False Then Return
...
#Region "Resource Editor"
    ...
    Friend Sub ResourceEditorInit()
        ...
        If frmEditor_Resource.Visible = False Then Return
...
#Region "Skill Editor"
    ...
    Friend Sub SkillEditorInit()
        ...
        If frmEditor_Skill.Visible = False Then Return
...
#Region "Shop editor"
    ...
    Friend Sub ShopEditorInit()
        ...
        If frmEditor_Shop.Visible = False Then Return
...
#Region "Class Editor"
    ...
    Friend Sub LoadClass()
        ...
        If Editorindex <= 0 OrElse Editorindex > MAX_CLASSES Then Return
...
#Region "Item"
    ...
    Friend Sub ItemEditorInit()
        ...
        If frmEditor_Item.Visible = False Then Return
