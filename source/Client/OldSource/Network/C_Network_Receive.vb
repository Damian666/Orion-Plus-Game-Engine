...
Module C_Network_Receive
    ...
    Private Sub Packet_ActionMessage(ByRef data() As Byte)
        ...
        'TODO: CreateActionMsg(message, color, tmpType, x, y)
    End Sub

    Private Sub Packet_Blood(ByRef data() As Byte)
        Dim buffer As New ByteStream(data)

        Graphics.BloodInstance.Add(
            New Graphics.BloodDef(buffer.ReadInt32, buffer.ReadInt32))
