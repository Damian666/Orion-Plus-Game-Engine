...
Namespace Network
    Partial Friend Module modNetwork
        ...
        Friend Sub InitializePacketPointers()
            Socket.PacketId(ClientPacket.CCheckPing) = AddressOf Packet_Ping
            Socket.PacketId(ClientPacket.CNewAccount) = AddressOf Packet_NewAccount
            Socket.PacketId(ClientPacket.CDelAccount) = AddressOf Packet_DeleteAccount
            Socket.PacketId(ClientPacket.CLogin) = AddressOf Packet_Login
            Socket.PacketId(ClientPacket.CAddChar) = AddressOf Packet_AddChar
            Socket.PacketId(ClientPacket.CUseChar) = AddressOf Packet_UseChar
            Socket.PacketId(ClientPacket.CDelChar) = AddressOf Packet_DeleteChar
            Socket.PacketId(ClientPacket.CSayMsg) = AddressOf Packet_SayMessage
            Socket.PacketId(ClientPacket.CBroadcastMsg) = AddressOf Packet_BroadCastMsg
            Socket.PacketId(ClientPacket.CPlayerMsg) = AddressOf Packet_PlayerMsg
            Socket.PacketId(ClientPacket.CPlayerMove) = AddressOf Packet_PlayerMove
            Socket.PacketId(ClientPacket.CPlayerDir) = AddressOf Packet_PlayerDirection
            Socket.PacketId(ClientPacket.CUseItem) = AddressOf Packet_UseItem
            Socket.PacketId(ClientPacket.CAttack) = AddressOf Packet_Attack
            Socket.PacketId(ClientPacket.CPlayerInfoRequest) = AddressOf Packet_PlayerInfo
            Socket.PacketId(ClientPacket.CWarpMeTo) = AddressOf Packet_WarpMeTo
            Socket.PacketId(ClientPacket.CWarpToMe) = AddressOf Packet_WarpToMe
            Socket.PacketId(ClientPacket.CWarpTo) = AddressOf Packet_WarpTo
            Socket.PacketId(ClientPacket.CSetSprite) = AddressOf Packet_SetSprite
            Socket.PacketId(ClientPacket.CGetStats) = AddressOf Packet_GetStats
            Socket.PacketId(ClientPacket.CRequestNewMap) = AddressOf Packet_RequestNewMap
            Socket.PacketId(ClientPacket.CSaveMap) = AddressOf Packet_MapData
            Socket.PacketId(ClientPacket.CNeedMap) = AddressOf Packet_NeedMap
            Socket.PacketId(ClientPacket.CMapGetItem) = AddressOf Packet_GetItem
            Socket.PacketId(ClientPacket.CMapDropItem) = AddressOf Packet_DropItem
            Socket.PacketId(ClientPacket.CMapRespawn) = AddressOf Packet_RespawnMap
            Socket.PacketId(ClientPacket.CMapReport) = AddressOf Packet_MapReport 'Mapreport
            Socket.PacketId(ClientPacket.CKickPlayer) = AddressOf Packet_KickPlayer
            Socket.PacketId(ClientPacket.CBanList) = AddressOf Packet_Banlist
            Socket.PacketId(ClientPacket.CBanDestroy) = AddressOf Packet_DestroyBans
            Socket.PacketId(ClientPacket.CBanPlayer) = AddressOf Packet_BanPlayer

            Socket.PacketId(ClientPacket.CRequestEditMap) = AddressOf Packet_EditMapRequest

            Socket.PacketId(ClientPacket.CSetAccess) = AddressOf Packet_SetAccess
            Socket.PacketId(ClientPacket.CWhosOnline) = AddressOf Packet_WhosOnline
            Socket.PacketId(ClientPacket.CSetMotd) = AddressOf Packet_SetMotd
            Socket.PacketId(ClientPacket.CSearch) = AddressOf Packet_PlayerSearch
            Socket.PacketId(ClientPacket.CSkills) = AddressOf Packet_Skills
            Socket.PacketId(ClientPacket.CCast) = AddressOf Packet_Cast
            Socket.PacketId(ClientPacket.CQuit) = AddressOf Packet_QuitGame
            Socket.PacketId(ClientPacket.CSwapInvSlots) = AddressOf Packet_SwapInvSlots

            Socket.PacketId(ClientPacket.CCheckPing) = AddressOf Packet_CheckPing
            Socket.PacketId(ClientPacket.CUnequip) = AddressOf Packet_Unequip
            Socket.PacketId(ClientPacket.CRequestPlayerData) = AddressOf Packet_RequestPlayerData
            Socket.PacketId(ClientPacket.CRequestItems) = AddressOf Packet_RequestItems
            Socket.PacketId(ClientPacket.CRequestNPCS) = AddressOf Packet_RequestNpcs
            Socket.PacketId(ClientPacket.CRequestResources) = AddressOf Packet_RequestResources
            Socket.PacketId(ClientPacket.CSpawnItem) = AddressOf Packet_SpawnItem
            Socket.PacketId(ClientPacket.CTrainStat) = AddressOf Packet_TrainStat

            Socket.PacketId(ClientPacket.CRequestAnimations) = AddressOf Packet_RequestAnimations
            Socket.PacketId(ClientPacket.CRequestSkills) = AddressOf Packet_RequestSkills
            Socket.PacketId(ClientPacket.CRequestShops) = AddressOf Packet_RequestShops
            Socket.PacketId(ClientPacket.CRequestLevelUp) = AddressOf Packet_RequestLevelUp
            Socket.PacketId(ClientPacket.CForgetSkill) = AddressOf Packet_ForgetSkill
            Socket.PacketId(ClientPacket.CCloseShop) = AddressOf Packet_CloseShop
            Socket.PacketId(ClientPacket.CBuyItem) = AddressOf Packet_BuyItem
            Socket.PacketId(ClientPacket.CSellItem) = AddressOf Packet_SellItem
            Socket.PacketId(ClientPacket.CChangeBankSlots) = AddressOf Packet_ChangeBankSlots
            Socket.PacketId(ClientPacket.CDepositItem) = AddressOf Packet_DepositItem
            Socket.PacketId(ClientPacket.CWithdrawItem) = AddressOf Packet_WithdrawItem
            Socket.PacketId(ClientPacket.CCloseBank) = AddressOf Packet_CloseBank
            Socket.PacketId(ClientPacket.CAdminWarp) = AddressOf Packet_AdminWarp

            Socket.PacketId(ClientPacket.CTradeInvite) = AddressOf Packet_TradeInvite
            Socket.PacketId(ClientPacket.CTradeInviteAccept) = AddressOf Packet_TradeInviteAccept
            Socket.PacketId(ClientPacket.CAcceptTrade) = AddressOf Packet_AcceptTrade
            Socket.PacketId(ClientPacket.CDeclineTrade) = AddressOf Packet_DeclineTrade
            Socket.PacketId(ClientPacket.CTradeItem) = AddressOf Packet_TradeItem
            Socket.PacketId(ClientPacket.CUntradeItem) = AddressOf Packet_UntradeItem

            Socket.PacketId(ClientPacket.CAdmin) = AddressOf Packet_Admin

            'quests
            Socket.PacketId(ClientPacket.CRequestQuests) = AddressOf Packet_RequestQuests
            Socket.PacketId(ClientPacket.CQuestLogUpdate) = AddressOf Packet_QuestLogUpdate
            Socket.PacketId(ClientPacket.CPlayerHandleQuest) = AddressOf Packet_PlayerHandleQuest
            Socket.PacketId(ClientPacket.CQuestReset) = AddressOf Packet_QuestReset

            'Housing
            Socket.PacketId(ClientPacket.CBuyHouse) = AddressOf Packet_BuyHouse
            Socket.PacketId(ClientPacket.CVisit) = AddressOf Packet_InviteToHouse
            Socket.PacketId(ClientPacket.CAcceptVisit) = AddressOf Packet_AcceptInvite
            Socket.PacketId(ClientPacket.CPlaceFurniture) = AddressOf Packet_PlaceFurniture

            Socket.PacketId(ClientPacket.CSellHouse) = AddressOf Packet_SellHouse

            'hotbar
            Socket.PacketId(ClientPacket.CSetHotbarSlot) = AddressOf Packet_SetHotBarSlot
            Socket.PacketId(ClientPacket.CDeleteHotbarSlot) = AddressOf Packet_DeleteHotBarSlot
            Socket.PacketId(ClientPacket.CUseHotbarSlot) = AddressOf Packet_UseHotBarSlot

            'Events
            Socket.PacketId(ClientPacket.CEventChatReply) = AddressOf Packet_EventChatReply
            Socket.PacketId(ClientPacket.CEvent) = AddressOf Packet_Event
            Socket.PacketId(ClientPacket.CRequestSwitchesAndVariables) = AddressOf Packet_RequestSwitchesAndVariables
            Socket.PacketId(ClientPacket.CSwitchesAndVariables) = AddressOf Packet_SwitchesAndVariables

            'projectiles

            Socket.PacketId(ClientPacket.CRequestProjectiles) = AddressOf HandleRequestProjectiles
            Socket.PacketId(ClientPacket.CClearProjectile) = AddressOf HandleClearProjectile

            'craft
            Socket.PacketId(ClientPacket.CRequestRecipes) = AddressOf Packet_RequestRecipes

            Socket.PacketId(ClientPacket.CCloseCraft) = AddressOf Packet_CloseCraft
            Socket.PacketId(ClientPacket.CStartCraft) = AddressOf Packet_StartCraft

            Socket.PacketId(ClientPacket.CRequestClasses) = AddressOf Packet_RequestClasses

            'emotes
            Socket.PacketId(ClientPacket.CEmote) = AddressOf Packet_Emote

            'parties
            Socket.PacketId(ClientPacket.CRequestParty) = AddressOf Packet_PartyRquest
            Socket.PacketId(ClientPacket.CAcceptParty) = AddressOf Packet_AcceptParty
            Socket.PacketId(ClientPacket.CDeclineParty) = AddressOf Packet_DeclineParty
            Socket.PacketId(ClientPacket.CLeaveParty) = AddressOf Packet_LeaveParty
            Socket.PacketId(ClientPacket.CPartyChatMsg) = AddressOf Packet_PartyChatMsg

            'pets
            Socket.PacketId(ClientPacket.CRequestPets) = AddressOf Packet_RequestPets
            Socket.PacketId(ClientPacket.CSummonPet) = AddressOf Packet_SummonPet
            Socket.PacketId(ClientPacket.CPetMove) = AddressOf Packet_PetMove
            Socket.PacketId(ClientPacket.CSetBehaviour) = AddressOf Packet_SetPetBehaviour
            Socket.PacketId(ClientPacket.CReleasePet) = AddressOf Packet_ReleasePet
            Socket.PacketId(ClientPacket.CPetSkill) = AddressOf Packet_PetSkill
            Socket.PacketId(ClientPacket.CPetUseStatPoint) = AddressOf Packet_UsePetStatPoint
        ...
        Private Sub Packet_NewAccount(index As Integer, ByRef data() As Byte)
            ...
            If Not IsPlaying(index) AndAlso Not IsLoggedIn(index) Then
                'Get the Data
                username = Configuration.Encryption.DecryptString(buffer.ReadString)
                password = Configuration.Encryption.DecryptString(buffer.ReadString)
                ' Prevent hacking
                ...
                If Not AccountExist(username) Then
                    ...
                    If Player(index).Character(TempPlayer(index).CurChar).Name.Trim.Length > 0 Then
                        ' we have a char!
                        HandleUseChar(index)
                    Else
                        ' send new char shit
        ...
        Private Sub Packet_Login(index As Integer, ByRef data() As Byte)
            ...
            If Not IsPlaying(index) Then
                If Not IsLoggedIn(index) Then
                    ...
                    ' Get the data
                    Name = Configuration.Encryption.DecryptString(buffer.ReadString())
                    Password = Configuration.Encryption.DecryptString(buffer.ReadString())

                    ' Check versions
                    If Configuration.Encryption.DecryptString(buffer.ReadString()) <> Application.ProductVersion Then
                        AlertMsg(index, "Version outdated, please visit " & Configuration.Settings.Website)
                        Exit Sub
                    End If
                    ...
                    buffer.WriteInt32(ServerPacket.SLoginOk)
                    ...
                    For i = 1 To MAX_CHARS
                        If Player(index).Character(i).Classes <= 0 Then
                            ...
                            buffer.WriteInt32(0)
                        Else
                            buffer.WriteString(Player(index).Character(i).Name.Trim)
                            buffer.WriteInt32(Player(index).Character(i).Sprite)
                            buffer.WriteInt32(Player(index).Character(i).Level)
                            buffer.WriteString(Classes(Player(index).Character(i).Classes).Name.Trim)
                            buffer.WriteInt32(Player(index).Character(i).Sex)
                        End If

                    Next

                    Socket.SendDataTo(index, buffer.ToPacket)
...
#End If
        ...
        Private Sub Packet_UseChar(index As Integer, ByRef data() As Byte)
            ...
            If Not IsPlaying(index) Then
                If IsLoggedIn(index) Then
                    ...
                    ' Check if character data has been created
                    If Player(index).Character(slot).Name.Trim.Length > 0 Then
                        ' we have a char!
                        TempPlayer(index).CurChar = slot
                        HandleUseChar(index)
                        ClearBank(index)
                        LoadBank(index, Player(index).Login.Trim)
                    Else
                        ' send new char shit
                        If Not IsPlaying(index) Then
                            SendNewCharClasses(index)
        ...
        Private Sub Packet_DeleteChar(index As Integer, ByRef data() As Byte)
            ...
            If Not IsPlaying(index) Then
                If IsLoggedIn(index) Then
                    ...
                    If Player(index).Character(slot).Name.Trim.Length > 0 Then
                        ' we have a char!
                        DeleteName(Player(index).Character(slot).Name.Trim)
        ...
        Sub Packet_PlayerDirection(index As Integer, ByRef data() As Byte)
            ...
            buffer = New ByteStream(4)
            buffer.WriteInt32(ServerPacket.SPlayerDir)
            buffer.WriteInt32(index)
            buffer.WriteInt32(GetPlayerDir(index))
            SendDataToMapBut(index, GetPlayerMap(index), buffer.ToPacket)
        ...
        Sub Packet_Attack(index As Integer, ByRef data() As Byte)
            ...
            buffer.WriteInt32(index)
            SendDataToMap(GetPlayerMap(index), buffer.ToPacket)
            buffer.Dispose()
        ...
        Sub Packet_PlayerInfo(index As Integer, ByRef data() As Byte)
            ...
            If i > 0 Then
                PlayerMsg(index, "Account:  " & Player(i).Login.Trim & ", Name: " & GetPlayerName(i), ColorType.Yellow)
            ...
            If n <> index Then
                If n > 0 Then
                    If GetPlayerAccess(n) < GetPlayerAccess(index) Then
                        GlobalMsg(GetPlayerName(n) & " has been kicked from " & Configuration.Settings.GameName & " by " & GetPlayerName(index) & "!")
        ...
        Private Sub Packet_EditMapRequest(index As Integer, ByRef data() As Byte)
            ...
            Buffer.WriteInt32(ServerPacket.SEditMap)
            Socket.SendDataTo(index, Buffer.ToPacket)
            Buffer.Dispose()
        End Sub
        ...
        Sub Packet_EditShop(index As Integer, ByRef data() As Byte)
            ...
            Buffer.WriteInt32(ServerPacket.SShopEditor)
            Socket.SendDataTo(index, Buffer.ToPacket)
        ...
        Sub Packet_EditSkill(index As Integer, ByRef data() As Byte)
            ...
            Dim Buffer = New ByteStream(4)
            Buffer.WriteInt32(ServerPacket.SSkillEditor)
            Socket.SendDataTo(index, Buffer.ToPacket)
        ...
        Sub Packet_SetMotd(index As Integer, ByRef data() As Byte)
            ...
            Configuration.Settings.Welcome = buffer.ReadString.Trim
            Configuration.SaveSettings()

            GlobalMsg("Welcome changed to: " & Configuration.Settings.Welcome)
            Addlog(GetPlayerName(index) & " changed MOTD to: " & Configuration.Settings.Welcome, ADMIN_LOG)
                ...
                If MapItem(GetPlayerMap(index), i).Num > 0 Then
                    If MapItem(GetPlayerMap(index), i).X = x Then
                        If MapItem(GetPlayerMap(index), i).Y = y Then
                            PlayerMsg(index, "You see " & CheckGrammar(Item(MapItem(GetPlayerMap(index), i).Num).Name.Trim) & ".", ColorType.White)
                            Exit Sub
                        End If
                    End If
                End If
                ...
                If MapNpc(GetPlayerMap(index)).Npc(i).Num > 0 Then
                    If MapNpc(GetPlayerMap(index)).Npc(i).X = x Then
                        If MapNpc(GetPlayerMap(index)).Npc(i).Y = y Then
                            ...
                            PlayerMsg(index, "Your target is now " & CheckGrammar(Npc(MapNpc(GetPlayerMap(index)).Npc(i).Num).Name.Trim) & ".", ColorType.Yellow)
                            SendTarget(index, TempPlayer(index).Target, TempPlayer(index).TargetType)
                            TargetFound = 1
                            Exit Sub
                        End If
        ...
        Sub Packet_CheckPing(index As Integer, ByRef data() As Byte)
            ...
            buffer = New ByteStream(4)
            buffer.WriteInt32(ServerPacket.SSendPing)
            Socket.SendDataTo(index, buffer.ToPacket)
        ...
        Sub Packet_SellItem(index As Integer, ByRef data() As Byte)
            ...
            ' send confirmation message & reset their shop action
            PlayerMsg(index, "Sold the " & Item(GetPlayerInvItemNum(index, invSlot)).Name.Trim & " !", ColorType.BrightGreen)
            ResetShopAction(index)
        ...
        Sub Packet_TradeInvite(index As Integer, ByRef data() As Byte)
            ...
            PlayerMsg(tradetarget, GetPlayerName(index).Trim & " has invited you to trade.", ColorType.Yellow)
            PlayerMsg(index, "You have invited " & GetPlayerName(tradetarget).Trim & " to trade.", ColorType.BrightGreen)
        ...
        Sub Packet_TradeInviteAccept(index As Integer, ByRef data() As Byte)
            ...
            If TempPlayer(tradetarget).TradeRequest = index Then
                ...
                PlayerMsg(index, "You have accepted " & GetPlayerName(tradetarget).Trim & "'s trade request.", ColorType.Yellow)
                PlayerMsg(tradetarget, GetPlayerName(index).Trim & " has accepted your trade request.", ColorType.BrightGreen)
        ...
        Sub HackingAttempt(index As Integer, Reason As String)
            ...
            If index > 0 AndAlso IsPlaying(index) Then
                ...
                AlertMsg(index, "You have lost your connection with " & Configuration.Settings.GameName & ".")
            End If
        ...
        Private Sub Packet_EditorLogin(index As Integer, ByRef data() As Byte)
            ...
            If Not IsLoggedIn(index) Then
                ...
                Name = Configuration.Encryption.DecryptString(buffer.ReadString)
                Password = Configuration.Encryption.DecryptString(buffer.ReadString)
                Version = Configuration.Encryption.DecryptString(buffer.ReadString)
