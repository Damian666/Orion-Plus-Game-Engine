                    ...
                    Else
                        Select Case Power
                            Case 0
                                ...
                                Network.SendPlayerData(Pindex)
                                Network.PlayerMsg(Pindex, "Your PowerLevel has been set to Player Rank!", ColorType.BrightCyan)
                                Console.WriteLine("Successfully set the power level to " & Power & " for player " & Name)
                            Case 1
                                SetPlayerAccess(Pindex, Power)
                                Network.SendPlayerData(Pindex)
                                Network.PlayerMsg(Pindex, "Your PowerLevel has been set to Monitor Rank!", ColorType.BrightCyan)
                                Console.WriteLine("Successfully set the power level to " & Power & " for player " & Name)
                            Case 2
                                SetPlayerAccess(Pindex, Power)
                                Network.SendPlayerData(Pindex)
                                Network.PlayerMsg(Pindex, "Your PowerLevel has been set to Mapper Rank!", ColorType.BrightCyan)
                                Console.WriteLine("Successfully set the power level to " & Power & " for player " & Name)
                            Case 3
                                SetPlayerAccess(Pindex, Power)
                                Network.SendPlayerData(Pindex)
                                Network.PlayerMsg(Pindex, "Your PowerLevel has been set to Developer Rank!", ColorType.BrightCyan)
                                Console.WriteLine("Successfully set the power level to " & Power & " for player " & Name)
                            Case 4
                                SetPlayerAccess(Pindex, Power)
                                Network.SendPlayerData(Pindex)
                                Network.PlayerMsg(Pindex, "Your PowerLevel has been set to Creator Rank!", ColorType.BrightCyan)
                                Console.WriteLine("Successfully set the power level to " & Power & " for player " & Name)
                            Case Else
...
#Region " Body "
                    ...
                    If Not Pindex > 0 Then
                        Console.WriteLine("Player name is empty or invalid. [Name not found]")
                    Else
                        Network.AlertMsg(Pindex, "You have been kicked by the server owner!")
                        LeftGame(Pindex)
                    End If
