...
#Region "Database"
    ...
    Sub SaveProjectile(ProjectileNum As Integer)
        ...
        filename = Path.Combine(Environment.CurrentDirectory, "data", "projectiles", String.Format("projectile{0}.dat", ProjectileNum))
    ...
    Sub LoadProjectiles()
        ...
        For i = 1 To MAX_PROJECTILES
            filename = Path.Combine(Environment.CurrentDirectory, "data", "projectiles", String.Format("projectile{0}.dat", i))
    ...
    Sub CheckProjectile()
        ...
        For i = 1 To MAX_PROJECTILES
            If Not File.Exists(Path.Combine(Environment.CurrentDirectory, "data", "projectiles", String.Format("projectile{0}.dat", i))) Then
                SaveProjectile(i)
            End If
        Next
...
#Region "Incoming"
    ...
    Sub HandleRequestEditProjectiles(index As Integer, ByRef data() As Byte)
        ...
        buffer.WriteInt32(ServerPacket.SProjectileEditor)
                ...
                If MapProjectiles(mapNum, ProjectileNum).Owner = index Then
                    Select Case TargetType
                        Case TargetType.Player
                            ...
                            If Network.IsPlaying(Targetindex) Then
...
#Region "Outgoing"
    ...
    Sub SendUpdateProjectileToAll(ProjectileNum As Integer)
        ...
        buffer.WriteInt32(ServerPacket.SUpdateProjectile)
    ...
    Sub SendProjectiles(index As Integer)
        ...
        For i = 1 To MAX_PROJECTILES
            If Projectiles(i).Name.Trim.Length > 0 Then
    ...
    Sub SendProjectileToMap(mapNum As Integer, ProjectileNum As Integer)
        ...
        buffer = New ByteStream(4)
        buffer.WriteInt32(ServerPacket.SMapProjectile)
