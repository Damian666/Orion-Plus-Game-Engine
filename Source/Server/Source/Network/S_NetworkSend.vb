...
Namespace Network
    Partial Friend Module modNetwork
        Sub AlertMsg(index As Integer, Msg As String)
            ...
            buffer.WriteInt32(ServerPacket.SAlertMsg)
        ...
        Sub GlobalMsg(Msg As String)
            ...
            buffer.WriteInt32(ServerPacket.SGlobalMsg)
            buffer.WriteString((Msg))
            SendDataToAll(buffer.ToPacket)
        ...
        Sub PlayerMsg(index As Integer, Msg As String, Colour As Integer)
            Dim buffer As New ByteStream(4)
            buffer.WriteInt32(ServerPacket.SPlayerMsg)
            'buffer.Writestring((Msg)
            buffer.WriteString((Msg))
        ...
        Sub SendNewCharClasses(index As Integer)
            ...
            Dim buffer As New ByteStream(4)
            buffer.WriteInt32(ServerPacket.SNewCharClasses)
        ...
        Sub SendCloseTrade(index As Integer)
            Dim buffer As New ByteStream(4)
            buffer.WriteInt32(ServerPacket.SCloseTrade)
            Socket.SendDataTo(index, buffer.ToPacket)
        ...
        Sub SendExp(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SPlayerEXP)
        ...
        Sub SendLoadCharOk(index As Integer)
            Dim Buffer As New ByteStream(4)
            Buffer.WriteInt32(ServerPacket.SLoadCharOk)
            Buffer.WriteInt32(index)
            Socket.SendDataTo(index, buffer.ToPacket)
        ...
        Sub SendInGame(index As Integer)
            Dim Buffer As New ByteStream(4)
            Buffer.WriteInt32(ServerPacket.SInGame)
            Socket.SendDataTo(index, buffer.ToPacket)
        ...
        Sub SendClasses(index As Integer)
            'Dim i As Integer, n As Integer, q As Integer
            Dim buffer As New ByteStream(4)
            buffer.WriteInt32(ServerPacket.SClassesData)
        ...
        Sub SendInventory(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SPlayerInv)
        ...
        Sub SendLeftMap(index As Integer)
            ...
            buffer.WriteInt32(index)
            SendDataToAllBut(index, buffer.ToPacket)
        ...
        Sub SendLeftGame(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SLeftGame)
        ...
        Sub SendMapEquipment(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SMapWornEq)
            buffer.WriteInt32(index)
        ...
        Sub SendUpdateShopTo(index As Integer, shopNum As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SUpdateShop)
        ...
        Sub SendUpdateSkillTo(index As Integer, skillnum As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SUpdateSkill)
        ...
        Sub SendStats(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SPlayerStats)
            buffer.WriteInt32(index)
        ...
        Sub SendVital(index As Integer, Vital As VitalType)
            ...
            Select Case Vital
                Case VitalType.HP
                    buffer.WriteInt32(ServerPacket.SPlayerHp)
                    AddDebug("Sent SMSG: SPlayerHp")
                Case VitalType.MP
                    buffer.WriteInt32(ServerPacket.SPlayerMp)
                    AddDebug("Sent SMSG: SPlayerMp")
                Case VitalType.SP
                    buffer.WriteInt32(ServerPacket.SPlayerSp)
        ...
        Sub SendWelcome(index As Integer)
            ...
            ' Send them MOTD
            If Configuration.Settings.Welcome.Trim.Length > 0 Then
                PlayerMsg(index, Configuration.Settings.Welcome, ColorType.BrightCyan)
            End If
        ...
        Sub SendWornEquipment(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SPlayerWornEq)
        ...
        Sub SendMapData(index As Integer, mapNum As Integer, SendMap As Boolean)
            ...
            buffer.WriteInt32(ServerPacket.SMapData)
        ...
        Sub SendJoinMap(index As Integer)
            ...
            SendDataToMap(GetPlayerMap(index), data)
        End Sub
        ...
        Function PlayerData(index As Integer) As Byte()
            ...
            buffer.WriteInt32(ServerPacket.SPlayerData)
            buffer.WriteInt32(index)
        ...
        Sub SendPlayerXY(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SPlayerXY)
            buffer.WriteInt32(GetPlayerX(index))
            buffer.WriteInt32(GetPlayerY(index))
            buffer.WriteInt32(GetPlayerDir(index))
        ...
        Sub SendPlayerMove(index As Integer, Movement As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SPlayerMove)
            buffer.WriteInt32(index)
            buffer.WriteInt32(GetPlayerX(index))
            buffer.WriteInt32(GetPlayerY(index))
            buffer.WriteInt32(GetPlayerDir(index))
        ...
        Sub SendDoorAnimation(mapNum As Integer, X As Integer, Y As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SDoorAnimation)
            buffer.WriteInt32(X)
            buffer.WriteInt32(Y)

            AddDebug("Sent SMSG: SDoorAnimation")

            SendDataToMap(mapNum, buffer.ToPacket)
        ...
        Sub SendMapKey(index As Integer, X As Integer, Y As Integer, Value As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SMapKey)
            buffer.WriteInt32(X)
            buffer.WriteInt32(Y)
        ...
        Sub MapMsg(mapNum As Integer, Msg As String, Color As Byte)
            ...
            buffer.WriteInt32(ServerPacket.SMapMsg)
        ...
        Sub SendActionMsg(mapNum As Integer, Message As String, Color As Integer, MsgType As Integer, X As Integer, Y As Integer, Optional PlayerOnlyNum As Integer = 0)
            ...
            buffer.WriteInt32(ServerPacket.SActionMsg)
            ...
            If PlayerOnlyNum > 0 Then
                Socket.SendDataTo(PlayerOnlyNum, buffer.ToPacket)
            Else
                SendDataToMap(mapNum, buffer.ToPacket)
            End If
        ...
        Sub SayMsg_Map(mapNum As Integer, index As Integer, Message As String, SayColour As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SSayMsg)
            buffer.WriteString(GetPlayerName(index).Trim)
            buffer.WriteInt32(GetPlayerAccess(index))
            buffer.WriteInt32(GetPlayerPK(index))
            buffer.WriteString(Message.Trim)
        ...
        Sub SendGameData(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SGameData)
        ...
        Sub SendInventoryUpdate(index As Integer, InvSlot As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SPlayerInvUpdate)
        ...
        Sub SendOpenShop(index As Integer, ShopNum As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SOpenShop)
            buffer.WriteInt32(ShopNum)
            Socket.SendDataTo(index, buffer.ToPacket)
        ...
        Sub ResetShopAction(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SResetShopAction)
        ...
        Sub SendBank(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SBank)
        ...
        Sub SendClearSkillBuffer(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SClearSkillBuffer)
        ...
        Sub SendClearTradeTimer(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SClearTradeTimer)
        ...
        Sub SendTradeInvite(index As Integer, Tradeindex As Integer)
            ...
            buffer.WriteInt32(ServerPacket.STradeInvite)
        ...
        Sub SendTrade(index As Integer, TradeTarget As Integer)
            ...
            buffer.WriteInt32(ServerPacket.STrade)
        ...
        Sub SendTradeUpdate(index As Integer, DataType As Byte)
            ...
            buffer.WriteInt32(ServerPacket.STradeUpdate)
        ...
        Sub SendTradeStatus(index As Integer, Status As Byte)
            ...
            buffer.WriteInt32(ServerPacket.STradeStatus)
        ...
        Sub SendStunned(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SStunned)
        ...
        Sub SendBlood(mapNum As Integer, X As Integer, Y As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SBlood)
            buffer.WriteInt32(X)
            buffer.WriteInt32(Y)
        ...
        Sub SendPlayerSkills(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SSkills)
        ...
        Sub SendCooldown(index As Integer, Slot As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SCooldown)
        ...
        Sub SendTarget(index As Integer, Target As Integer, TargetType As Integer)
            ...
            buffer.WriteInt32(ServerPacket.STarget)
        ...
        Sub SendMapReport(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SMapReport)
        ...
        Sub SendAdminPanel(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SAdmin)
        ...
        Sub SendMapNames(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SMapNames)
        ...
        Sub SendHotbar(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SHotbar)
        ...
        Sub SendCritical(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SCritical)
        ...
        Sub SendEncryptionKey(index As Integer)
            Dim buffer As New ByteStream(4)

            buffer.WriteInt32(ServerPacket.SKeyPair)
            buffer.WriteString(Configuration.Encryption.ExportKeyString(False).Trim)
            Socket.SendDataTo(index, buffer.ToPacket)
        ...
        Sub SendNews(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SNews)

            AddDebug("Sent SMSG: SNews")

            buffer.WriteString(Configuration.Settings.GameName.Trim)
            buffer.WriteString(GetFileContents(Environment.CurrentDirectory & "\data\news.txt").Trim)
        ...
        Sub SendRightClick(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SrClick)
        ...
        Sub SendClassEditor(index As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SClassEditor)
        ...
        Sub SendEmote(index As Integer, Emote As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SEmote)
        ...
        Sub SendChatBubble(mapNum As Integer, Target As Integer, TargetType As Integer, Message As String, Colour As Integer)
            ...
            buffer.WriteInt32(ServerPacket.SChatBubble)
        ...
        Sub SendTotalOnlineTo(index As Integer)
            ...
            Buffer.WriteInt32(ServerPacket.STotalOnline)
