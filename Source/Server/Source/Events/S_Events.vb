...
#Region "Globals"
    ...
    'Effect Constants - Used for event Configuration.Settings...
...
#Region "Database"
    ...
    Sub CreateVariables()
        Dim path = Environment.CurrentDirectory & "\Data\Variables.ini"
    ...
    Sub SaveSwitches()
        Dim path = Environment.CurrentDirectory & "\Data\Switches.ini"
        If Not File.Exists(path) Then File.Create(path).Dispose
...
#Region "Movement"
    ...
    Sub EventDir(playerindex As Integer, mapNum As Integer, eventId As Integer, dir As Integer, Optional globalevent As Boolean = False)
        ...
        buffer.WriteInt32(ServerPacket.SEventDir)
        ...
        Select Case dir
            Case DirectionType.Up
                If globalevent Then
                    ...
                    buffer.WriteInt32(ServerPacket.SEventMove)
                    buffer.WriteInt32(eventId)
...
#Region "Outgoing Packets"
    Sub SendSpecialEffect(index As Integer, effectType As Integer, Optional data1 As Integer = 0, Optional data2 As Integer = 0, Optional data3 As Integer = 0, Optional data4 As Integer = 0)
        ...
        buffer.WriteInt32(ServerPacket.SSpecialEffect)
    ...
    Sub SendSwitchesAndVariables(index As Integer, Optional everyone As Boolean = False)
        ...
        buffer.WriteInt32(ServerPacket.SSwitchesAndVariables)
    ...
    Sub SendMapEventData(index As Integer)
        ...
        buffer.WriteInt32(ServerPacket.SMapEventData)
...
#Region "Misc"
    Friend Sub GivePlayerExp(index As Integer, exp As Integer)
        ...
        Network.SendActionMsg(GetPlayerMap(index), "+" & exp & " Exp", ColorType.White, 1, (GetPlayerX(index) * 32), (GetPlayerY(index) * 32))
        ...
        If PetAlive(index) Then
            If Pet(GetPetNum(index)).LevelingType = 0 Then
                ...
                Network.SendActionMsg(GetPlayerMap(index), "+" & (exp * (Pet(GetPetNum(index)).ExpGain / 100)) & " Exp", ColorType.White, 1, (GetPetX(index) * 32), (GetPetY(index) * 32))
    ...
    Friend Sub CustomScript(index As Integer, caseId As Integer, mapNum As Integer, eventId As Integer)
        ...
        Select Case caseId
            ...
            Case Else
                Network.PlayerMsg(index, "You just activated custom script " & caseId & ". This script is not yet programmed.", ColorType.BrightRed)
        End Select
