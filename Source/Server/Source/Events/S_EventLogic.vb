...
Friend Module S_EventLogic
    Friend Sub RemoveDeadEvents()
        ...
        For i = 1 To GetPlayersOnline()
            ...
            If Network.IsPlaying(i) = False Then
                    ...
                    If Map(mapNum).Events(id).PageCount >= page Then
                        ...
                        If TempPlayer(i).EventMap.EventPages(x).Visible = 1 Then
                            ...
                            If TempPlayer(i).EventMap.EventPages(x).Visible = 0 Then
                                ...
                                Buffer.WriteInt32(ServerPacket.SSpawnEvent)
                                Buffer.WriteInt32(id)
                                With TempPlayer(i).EventMap.EventPages(x)
                                    Buffer.WriteString((Map(GetPlayerMap(i)).Events(.EventId).Name.Trim))
                    ...
                    For z = Map(mapNum).Events(id).PageCount To 1 Step -1
                        ...
                        If spawnevent = True Then
                            ...
                            If TempPlayer(i).EventProcessingCount > 0 Then
                                For n = 1 To TempPlayer(i).EventProcessing.GetUpperBound(0)
                                            ...
                                            If .MoveRouteCount > 0 Then
                                                ...
                                                If donotprocessmoveroute = False Then
                                                    ...
                                                    If sendupdate Then
                                                        ...
                                                        With TempEventMap(i).Events(x)
                                                            Buffer.WriteString((Map(i).Events(x).Name.Trim))
                                                            Buffer.WriteInt32(.Dir)
                                                            Buffer.WriteInt32(.GraphicNum)
                                                            Buffer.WriteInt32(.GraphicType)
                                                            Buffer.WriteInt32(.GraphicX)
                                                            ...
                                                            Buffer.WriteInt32(.QuestNum)
                                                        End With
                                                        Network.SendDataToMap(i, Buffer.ToPacket)
                                                    ...
                                                    If donotprocessmoveroute = False Then
                                                        ...
                                                        If sendupdate Then
                                                            ...
                                                            With TempPlayer(playerID).EventMap.EventPages(eventID)
                                                                Buffer.WriteString((Map(GetPlayerMap(playerID)).Events(TempPlayer(playerID).EventMap.EventPages(eventID).EventId).Name.Trim))
                                                                Buffer.WriteInt32(.Dir)
                                                                Buffer.WriteInt32(.GraphicNum)
                                                                Buffer.WriteInt32(.GraphicType)
                                                                Buffer.WriteInt32(.GraphicX)
                                                                ...
                                                                Buffer.WriteInt32(.QuestNum)
                                                            End With
                                                            Network.SendDataTo(playerID, Buffer.ToPacket)
                                                            Buffer.Dispose()
                                                        End If
                                                    End If
                                                    donotprocessmoveroute = False
    ...
    Friend Sub ProcessEventCommands()
        ...
        For i = 1 To GetPlayersOnline()
            ...
            If Network.IsPlaying(i) AndAlso TempPlayer(i).GettingMap = 0 Then
                For x = 1 To TempPlayer(i).EventMap.CurrentEvents
                                                    ...
                                                    Select Case Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Index
                                                        Case EventType.EvAddText
                                                            Select Case Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data2
                                                                Case 0
                                                                    Network.PlayerMsg(i, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text1, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data1)
                                                                Case 1
                                                                    Network.MapMsg(GetPlayerMap(i), Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text1, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data1)
                                                                Case 2
                                                                    Network.GlobalMsg(Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text1) ' Map(GetPlayerMap(i)).Events(.EventID).Pages(.PageID).CommandList(.CurList).Commands(.CurSlot).Data1)
                                                            End Select
                                                        Case EventType.EvShowText
                                                            buffer = New ByteStream(4)
                                                            buffer.WriteInt32(ServerPacket.SEventChat)
                                                            buffer.WriteInt32(.EventId)
                                                            ...
                                                            buffer.WriteString(ParseEventText(i, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text1).Trim)
                                                            buffer.WriteInt32(0)
                                                        ...
                                                        Case EventType.EvShowChoices
                                                            ...
                                                            If Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text2.Trim.Length > 0 Then
                                                                w = 1
                                                                If Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text3.Trim.Length > 0 Then
                                                                    w = 2
                                                                    If Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text4.Trim.Length > 0 Then
                                                                        w = 3
                                                                        If Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text5.Trim.Length > 0 Then
                                                                            w = 4
                                                                        End If
                                                                    End If
                                                                End If
                                                            ...
                                                            For v = 1 To w
                                                                Select Case v
                                                                    Case 1
                                                                        buffer.WriteString(ParseEventText(i, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text2.Trim).Trim)
                                                                    Case 2
                                                                        buffer.WriteString(ParseEventText(i, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text3.Trim).Trim)
                                                                    Case 3
                                                                        buffer.WriteString(ParseEventText(i, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text4.Trim).Trim)
                                                                    Case 4
                                                                        buffer.WriteString(ParseEventText(i, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text5.Trim).Trim)
                                                                End Select
                                                            Next
                                                            If Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).CommandCount > .CurSlot Then
                                                                If Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot + 1).Index = EventType.EvShowText OrElse Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot + 1).Index = EventType.EvShowChoices Then
                                                        ...
                                                        Case EventType.EvPlayBgm
                                                            buffer = New ByteStream(4)
                                                            buffer.WriteInt32(ServerPacket.SPlayBGM)
                                                            buffer.WriteString(Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text1.Trim)
                                                            Network.SendDataTo(i, buffer.ToPacket)
                                                        ...
                                                        Case EventType.EvFadeoutBgm
                                                            buffer = New ByteStream(4)
                                                            buffer.WriteInt32(ServerPacket.SFadeoutBGM)
                                                            Network.SendDataTo(i, buffer.ToPacket)
                                                        ...
                                                        Case EventType.EvPlaySound
                                                            buffer = New ByteStream(4)
                                                            buffer.WriteInt32(ServerPacket.SPlaySound)
                                                            buffer.WriteString(Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text1.Trim)
                                                            Network.SendDataTo(i, buffer.ToPacket)
                                                        ...
                                                        Case EventType.EvStopSound
                                                            buffer = New ByteStream(4)
                                                            buffer.WriteInt32(ServerPacket.SStopSound)
                                                            Network.SendDataTo(i, buffer.ToPacket)
                                                        ...
                                                        Case EventType.EvOpenShop
                                                            If Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data1 > 0 Then ' shop exists?
                                                                If Shop(Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data1).Name.Trim.Length > 0 Then ' name exists?
                                                                    Network.SendOpenShop(i, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data1)
                                                        ...
                                                        Case EventType.EvShowChatBubble
                                                            Select Case Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data1
                                                                Case TargetType.Player
                                                                    Network.SendChatBubble(GetPlayerMap(i), i, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data1, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text1, ColorType.Brown)
                                                                Case TargetType.Npc
                                                                    Network.SendChatBubble(GetPlayerMap(i), Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data2, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Data1, Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text1, ColorType.Brown)
                                                        ...
                                                        Case EventType.EvGotoLabel
                                                            ...
                                                            FindEventLabel(Map(GetPlayerMap(i)).Events(.EventId).Pages(.PageId).CommandList(.CurList).Commands(.CurSlot).Text1.Trim, GetPlayerMap(i), .EventId, .PageId, .CurSlot, .CurList, .ListLeftOff)
                                                        ...
                                                        Case EventType.EvShowPicture
                                                            buffer = New ByteStream(4)
                                                            buffer.WriteInt32(ServerPacket.SPic)
                                                            buffer.WriteInt32(0)
                                                        ...
                                                        Case EventType.EvHoldPlayer
                                                            buffer = New ByteStream(4)
                                                            buffer.WriteInt32(ServerPacket.SHoldPlayer)
                                                            buffer.WriteInt32(0)
                                                            Network.SendDataTo(i, buffer.ToPacket)
    ...
    Function ParseEventText(index As Integer, txt As String) As String
        ...
        txt = txt.Replace("/name", Player(index).Character(TempPlayer(index).CurChar).Name.Trim)
        txt = txt.Replace("/p", Player(index).Character(TempPlayer(index).CurChar).Name.Trim)
        txt = txt.Replace("$playername$", Player(index).Character(TempPlayer(index).CurChar).Name.Trim)
        txt = txt.Replace("$playerclass$", Classes(Player(index).Character(TempPlayer(index).CurChar).Classes).Name.Trim)
        Do While txt.IndexOf("/v", 1) > 0
            x = txt.IndexOf("/v", 1)
            If x > 0 Then
                i = 0
                Do Until Not Single.TryParse(txt.Substring(x + 2 + i, 1), 0)
                    i = i + 1
                Loop
                newtxt = txt.Substring(1, x - 1)
                parsestring = txt.Substring(x + 2, i)
                z = Player(index).Character(TempPlayer(i).CurChar).Variables(CInt(parsestring))
                newtxt = newtxt & z
                newtxt = newtxt & txt.Substring(x + 2 + i, txt.Length - (x + i))
                txt = newtxt
            End If
        Loop
        ParseEventText = txt
            ...
            If restartlist = False Then
                If removeEventProcess = False Then
                    ...
                    Select Case Map(mapNum).Events(eventID).Pages(pageID).CommandList(CurList).Commands(CurSlot).Index
                        Case EventType.EvShowChoices
                            If Map(mapNum).Events(eventID).Pages(pageID).CommandList(CurList).Commands(CurSlot).Text2.Trim.Length > 0 Then
                                w = 1
                                If Map(mapNum).Events(eventID).Pages(pageID).CommandList(CurList).Commands(CurSlot).Text3.Trim.Length > 0 Then
                                    w = 2
                                    If Map(mapNum).Events(eventID).Pages(pageID).CommandList(CurList).Commands(CurSlot).Text4.Trim.Length > 0 Then
                                        w = 3
                                        If Map(mapNum).Events(eventID).Pages(pageID).CommandList(CurList).Commands(CurSlot).Text5.Trim.Length > 0 Then
                                            w = 4
                                        End If
                                    End If
                                End If
                        ...
                        Case EventType.EvLabel
                            'Do nothing, just a label
                            If Map(mapNum).Events(eventID).Pages(pageID).CommandList(CurList).Commands(CurSlot).Text1.Trim = Label.Trim Then
                                Exit Sub
                            End If
                    End Select
                    CurSlot = CurSlot + 1
        ...
        If TempPlayer(index).EventMap.CurrentEvents > 0 Then
            For i = 1 To TempPlayer(index).EventMap.CurrentEvents
                ...
                With TempPlayer(index).EventMap.EventPages(i)
                    buffer.WriteString((Map(GetPlayerMap(index)).Events(TempPlayer(index).EventMap.EventPages(i).EventId).Name.Trim))
                    buffer.WriteInt32(.Dir)
                    buffer.WriteInt32(.GraphicNum)
                    buffer.WriteInt32(.GraphicType)
                    buffer.WriteInt32(.GraphicX)
