...
#Region "Database"
    ...
    Sub SaveItem(itemNum As Integer)
        ...
        filename = Path.Combine(Environment.CurrentDirectory, "data", "items", String.Format("item{0}.dat", itemNum))
    ...
    Sub CheckItems()
        ...
        For i = 1 To MAX_ITEMS
            ...
            If Not File.Exists(Path.Combine(Environment.CurrentDirectory, "data", "items", String.Format("item{0}.dat", i))) Then
                SaveItem(i)
            End If
    ...
    Function ItemsData() As Byte()
        ...
        For i = 1 To MAX_ITEMS
            If Not Item(i).Name.Trim.Length > 0 Then Continue For
...
#Region "Map Items"
    Sub SendMapItemsTo(index As Integer, mapNum As Integer)
        ...
        buffer.WriteInt32(ServerPacket.SMapItemData)
    ...
    Sub SpawnItemSlot(MapItemSlot As Integer, itemNum As Integer, ItemVal As Integer, mapNum As Integer, x As Integer, y As Integer)
        ...
        If i <> 0 Then
            If itemNum >= 0 AndAlso itemNum <= MAX_ITEMS Then
                ...
                buffer.WriteInt32(ServerPacket.SSpawnItem)
                buffer.WriteInt32(i)
                buffer.WriteInt32(itemNum)
...
#Region "Incoming Packets"
    ...
    Sub Packet_EditItem(index As Integer, ByRef data() As Byte)
        ...
        Buffer.WriteInt32(ServerPacket.SItemEditor)
        Network.SendDataTo(index, buffer.ToPacket)
...
#Region "Outgoing Packets"
    Sub SendItems(index As Integer)
        ...
        For i = 1 To MAX_ITEMS
            If Item(i).Name.Trim.Length > 0 Then
    ...
    Sub SendUpdateItemTo(index As Integer, itemNum As Integer)
        Dim buffer As ByteStream
        buffer = New ByteStream(4)
        buffer.WriteInt32(ServerPacket.SUpdateItem)
