...
Module ClientDataBase
    ...
    Friend Sub CheckTilesets()
        ...
        While File.Exists(Environment.CurrentDirectory & GFX_PATH & "\tilesets\" & i & GFX_EXT)
        ...
        For i = 1 To NumTileSets
            tmp = New Bitmap(Environment.CurrentDirectory & GFX_PATH & "\tilesets\" & i & GFX_EXT)
    ...
    Friend Sub CheckCharacters()
        ...
        While File.Exists(Environment.CurrentDirectory & GFX_PATH & "characters\" & i & GFX_EXT)
    ...
    Friend Sub CheckPaperdolls()
        ...
        While File.Exists(Environment.CurrentDirectory & GFX_PATH & "paperdolls\" & i & GFX_EXT)
    ...
    Friend Sub CheckAnimations()
        ...
        While File.Exists(Environment.CurrentDirectory & GFX_PATH & "animations\" & i & GFX_EXT)
    ...
    Friend Sub CheckResources()
        ...
        While File.Exists(Environment.CurrentDirectory & GFX_PATH & "Resources\" & i & GFX_EXT)
    ...
    Friend Sub CheckSkillIcons()
        ...
        While File.Exists(Environment.CurrentDirectory & GFX_PATH & "SkillIcons\" & i & GFX_EXT)
    ...
    Friend Sub CheckFaces()
        ...
        While File.Exists(Environment.CurrentDirectory & GFX_PATH & "Faces\" & i & GFX_EXT)
            NumFaces = NumFaces + 1
            i = i + 1
        End While
    ...
    Friend Sub CheckFog()
        ...
        While File.Exists(Environment.CurrentDirectory & GFX_PATH & "Fogs\" & i & GFX_EXT)
            NumFogs = NumFogs + 1
            i = i + 1
        End While
    ...
    Friend Sub CacheMusic()
        Dim Files As String() = Directory.GetFiles(Environment.CurrentDirectory & MUSIC_PATH, "*.ogg")
        Dim MaxNum As String = Directory.GetFiles(Environment.CurrentDirectory & MUSIC_PATH, "*.ogg").Count
    ...
    Friend Sub CacheSound()
        Dim Files As String() = Directory.GetFiles(Environment.CurrentDirectory & SOUND_PATH, "*.ogg")
        Dim MaxNum As String = Directory.GetFiles(Environment.CurrentDirectory & SOUND_PATH, "*.ogg").Count
        Dim Counter As Integer = 1
