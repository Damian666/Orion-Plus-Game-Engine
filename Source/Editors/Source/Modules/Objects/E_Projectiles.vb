...
#Region "Drawing"
    ...
    Friend Sub CheckProjectiles()
        ...
        While File.Exists(Environment.CurrentDirectory & GFX_PATH & "projectiles\" & i & GFX_EXT)
    ...
    Friend Sub EditorProjectile_DrawProjectile()
        ...
        If File.Exists(Environment.CurrentDirectory & GFX_PATH & "Projectiles\" & iconnum & GFX_EXT) Then
            frmProjectile.picProjectile.BackgroundImage = Image.FromFile(Environment.CurrentDirectory & GFX_PATH & "Projectiles\" & iconnum & GFX_EXT)
        End If
