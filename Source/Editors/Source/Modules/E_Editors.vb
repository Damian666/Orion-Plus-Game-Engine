...
#Region "Shop editor"
    Friend Sub ShopEditorInit()
        ...
        If File.Exists(Environment.CurrentDirectory & GFX_PATH & "Faces\" & Shop(Editorindex).Face & GFX_EXT) Then
            frmShop.picFace.BackgroundImage = Image.FromFile(Environment.CurrentDirectory & GFX_PATH & "Faces\" & Shop(Editorindex).Face & GFX_EXT)
        End If
