...
Module E_Sound
    ...
    Sub PlayMusic(FileName As String)
        If Not Options.Music = 1 OrElse Not File.Exists(Environment.CurrentDirectory & MUSIC_PATH & FileName) Then Exit Sub
        If FileName = CurMusic Then Exit Sub

        If MusicPlayer Is Nothing Then
            Try
                MusicPlayer = New Music(Environment.CurrentDirectory & MUSIC_PATH & FileName)
    ...
    Sub PlayPreview(FileName As String)
        ...
        If PreviewPlayer Is Nothing Then
            Try
                PreviewPlayer = New Music(Environment.CurrentDirectory & MUSIC_PATH & FileName)
    ...
    Sub PlaySound(FileName As String, Optional Looped As Boolean = False)
        If Not Options.Sound = 1 OrElse Not File.Exists(Environment.CurrentDirectory & SOUND_PATH & FileName) Then Exit Sub

        dim buffer as SoundBuffer
        If SoundPlayer Is Nothing Then
            SoundPlayer = New Sound()
            buffer = New SoundBuffer(Environment.CurrentDirectory & SOUND_PATH & FileName)
