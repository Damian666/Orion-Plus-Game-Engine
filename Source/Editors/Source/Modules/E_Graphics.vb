...
Module E_Graphics
    ...
    Sub InitGraphics()
        ...
        If File.Exists(Environment.CurrentDirectory & GFX_PATH & "Misc\Door" & GFX_EXT) Then
            'Load texture first, dont care about memory streams (just use the filename)
            DoorGFX = New Texture(Environment.CurrentDirectory & GFX_PATH & "Misc\Door" & GFX_EXT)
        ...
        If File.Exists(Environment.CurrentDirectory & GFX_PATH & "Misc\Direction" & GFX_EXT) Then
            'Load texture first, dont care about memory streams (just use the filename)
            DirectionsGfx = New Texture(Environment.CurrentDirectory & GFX_PATH & "Misc\Direction" & GFX_EXT)
        ...
        If File.Exists(Environment.CurrentDirectory & GFX_PATH & "Misc\Weather" & GFX_EXT) Then
            'Load texture first, dont care about memory streams (just use the filename)
            WeatherGFX = New Texture(Environment.CurrentDirectory & GFX_PATH & "Misc\Weather" & GFX_EXT)
        ...
        If File.Exists(Environment.CurrentDirectory & GFX_PATH & "Misc\Light" & GFX_EXT) Then
            LightGfx = New Texture(Environment.CurrentDirectory & GFX_PATH & "Misc\Light" & GFX_EXT)
    ...
    Friend Sub LoadTexture(index as integer, TexType As Byte)
        ...
        If TexType = 1 Then 'tilesets
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            TileSetTexture(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "tilesets\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 2 Then 'characters
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            CharacterGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "characters\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 3 Then 'paperdoll
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            PaperDollGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "Paperdolls\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 4 Then 'items
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            ItemsGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "items\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 5 Then 'resources
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            ResourcesGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "resources\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 6 Then 'animations
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            AnimationsGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "Animations\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 7 Then 'faces
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            FacesGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "Faces\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 8 Then 'fogs
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            FogGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "Fogs\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 9 Then 'skill icons
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            SkillIconsGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "SkillIcons\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 10 Then 'furniture
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            FurnitureGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "Furniture\" & Index & GFX_EXT)
        ...
        ElseIf TexType = 11 Then 'projectiles
            ...
            'Load texture first, dont care about memory streams (just use the filename)
            ProjectileGFX(Index) = New Texture(Environment.CurrentDirectory & GFX_PATH & "Projectiles\" & Index & GFX_EXT)
    ...
    Friend Sub EditorNpc_DrawSprite()
        ...
        If File.Exists(Environment.CurrentDirectory & GFX_PATH & "characters\" & Sprite & GFX_EXT) Then
            frmNPC.picSprite.Width = Drawing.Image.FromFile(Environment.CurrentDirectory & GFX_PATH & "characters\" & Sprite & GFX_EXT).Width / 4
            frmNPC.picSprite.Height = Drawing.Image.FromFile(Environment.CurrentDirectory & GFX_PATH & "characters\" & Sprite & GFX_EXT).Height / 4
            frmNPC.picSprite.BackgroundImage = Drawing.Image.FromFile(Environment.CurrentDirectory & GFX_PATH & "characters\" & Sprite & GFX_EXT)
        End If
    End Sub
    ...
    Friend Sub EditorResource_DrawSprite()
        ...
        Else
            If File.Exists(Environment.CurrentDirectory & GFX_PATH & "resources\" & Sprite & GFX_EXT) Then
                frmResource.picNormalpic.BackgroundImage = Drawing.Image.FromFile(Environment.CurrentDirectory & GFX_PATH & "resources\" & Sprite & GFX_EXT)
            End If
        End If
        ...
        Else
            If File.Exists(Environment.CurrentDirectory & GFX_PATH & "resources\" & Sprite & GFX_EXT) Then
                frmResource.picExhaustedPic.BackgroundImage = Drawing.Image.FromFile(Environment.CurrentDirectory & GFX_PATH & "resources\" & Sprite & GFX_EXT)
            End If
        End If
    End Sub
