...
Namespace Network
    ...
    ' ' Main Menu Headers. Login Register ForgotPassword VerificationResend VerificationConfirm

    ' ' Character Select Headers. NewCharacter UseCharacter DelCharacter ChangePassword

    ' ' Game Database Headers. GameDatabaseRequest
    ...
    ' ' Main Menu Headers. CharacterSelect ForgotPassword Verification

    ' ' Character Select Headers. EnterGame RefreshCharacters ChangePassword

    ' ' Game Database Headers. GameDatabaseCheck GameDatabaseUpdate
