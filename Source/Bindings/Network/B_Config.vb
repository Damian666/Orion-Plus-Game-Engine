...
#End If
        ...
        ''' <summary>
        ''' Creates Or renews local "Socket" object for network use And establishes rules And functionality.
        ''' </summary>
...
#End If
        ...
        Friend Sub Destroy()
            ...
            ' Calling a disconnect is not necessary when using destroy network as Dispose already
            ' calls it and cleans up the memory internally.
...
#If CLIENT Then
        ...
        ''' <summary>
        ''' Returns true if connection exists. May return false positive if no data transfers attempt
...
#ElseIf SERVER Then
        ...
        ''' <summary>
        ''' Returns true if server is currently listening for incoming connections on any port.
        ''' </summary>
        ...
        ''' <summary>
        ''' Disconnects the client on "index" and clears their connection data from "Socket" object.
        ''' </summary>
        ...
        ''' <summary>
        ''' Returns true if connection exists on the index. May return false positive if no data
        ''' transfers attempt to occur between improper network closing on client side.
        ''' EX: Crash.
        ''' </summary>
        ...
        ''' <summary>
        ''' Send Packet-Data to all connections on the specified map except the specified index.
        ''' </summary>
...
#If DEBUG Then
        ...
        ''' <summary>
        ''' This packet is for debugging. Can be used to detect frequent traffic and what information
        ''' is sent in general. Intended use is mainly to detect how much data is sent over time and
        ''' sometimes catch spam/ddossers.
        ''' </summary>
        ...
        ''' <summary>
        ''' This packet is for debugging. Can be used to find broken packets, or detect data being
        ''' sent through faulty packets by a hacker, as well as just track what information
        ''' specificly is sent on a given packet.
        ''' </summary>
