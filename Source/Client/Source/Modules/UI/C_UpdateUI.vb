...
#End Region
    ...
    Sub UpdateUi()
        ...
        If Not cmbclass Is Nothing Then
            ...
            For i = 1 To cmbclass.GetUpperBound(0)
        ...
        If UpdateQuestChat = True Then
            DialogMsg1 = "Quest: " & Quest(QuestNum).Name.Trim
        ...
        If InitEventEditorForm = True Then
            ...
            With FrmEditor_Events
                ...
                For i = 1 To TmpEvent.PageCount
                    .tabPages.TabPages.Add(i.ToString())
                Next
                ' items
                .cmbHasItem.Items.Clear()
                .cmbHasItem.Items.Add("None")
                For i = 1 To MAX_ITEMS
                    .cmbHasItem.Items.Add(i & ": " & Item(i).Name.Trim)
                Next
                ' variables
        ...
        If OptionsVisible = True Then
            ...
            ' show in GUI
            If Configuration.Settings.Music = 1 Then
            ...
            frmOptions.lblVolume.Text = "Volume: " & Configuration.Settings.Volume
            frmOptions.scrlVolume.Value = Configuration.Settings.Volume

            frmOptions.cmbScreenSize.SelectedIndex = Configuration.Settings.ScreenSize
