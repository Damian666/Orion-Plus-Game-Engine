    ...
    Friend Sub CheckGuiMove(x As Integer, y As Integer)
            ...
            If AboveInvpanel(x, y) Then
                ...
                Else
                    ...
                    If invNum <> 0 Then
                        ...
                        For i = 1 To MAX_INV
                            If TradeYourOffer(i).Slot = invNum Then
                                Exit Sub
                            End If
                        Next
            ...
            If AboveBankpanel(x, y) Then
                ...
                Else
                    ...
                    If bankitem <> 0 Then
                        ...
                        UpdateDescWindow(Bank.Item(bankitem).Index, Bank.Item(bankitem).Amount, bankitem, 2)
                        ShowItemDesc = True
                        Exit Sub
                    Else
                        ShowItemDesc = False
        ...
        If PnlTradeVisible = True Then
            If AboveTradepanel(x, y) Then
                ...
                If tradeNum <> 0 Then
                    UpdateDescWindow(GetPlayerInvItemNum(Myindex, TradeYourOffer(tradeNum).Index), TradeYourOffer(tradeNum).Amount, tradeNum, 4)
                    LastItemDesc = GetPlayerInvItemNum(Myindex, TradeYourOffer(tradeNum).Index) ' set it so you don't re-set values
                    ShowItemDesc = True
                    Exit Sub
                Else
                    ShowItemDesc = False
                ...
                If tradeNum <> 0 Then
                    UpdateDescWindow(TradeTheirOffer(tradeNum).Index, TradeTheirOffer(tradeNum).Amount, tradeNum, 4)
                    LastItemDesc = TradeTheirOffer(tradeNum).Index ' set it so you don't re-set values
                    ShowItemDesc = True
                    Exit Sub
                Else
                    ShowItemDesc = False
            ...
            Else
                If FurnitureSelected > 0 Then
                    If Player(Myindex).InHouse = Myindex Then
                        If Item(PlayerInv(FurnitureSelected).Index).Type = ItemType.Furniture Then
                            buffer = New ByteStream(4)
...
#Region "Support Functions"
    ...
    Function IsTradeItem(x As Single, y As Single, yours As Boolean) As Integer
        ...
        For i = 1 To MAX_INV
            ...
            If yours Then
                itemnum = GetPlayerInvItemNum(Myindex, TradeYourOffer(i).Slot)
