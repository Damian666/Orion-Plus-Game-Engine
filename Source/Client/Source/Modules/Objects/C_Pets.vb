...
#Region "Drawing"
    ...
    Sub DrawPetStats()
        ...
        DrawText(PetStatX + 70, PetStatY + 10, petname & " Lvl: " & Player(Myindex).Pet.Level, Microsoft.Xna.Framework.Color.Yellow, Microsoft.Xna.Framework.Color.Black, GameWindow)
        ...
        'stats
        DrawText(PetStatX + 65, PetStatY + 50, "Strength: " & Player(Myindex).Pet.Stat(StatType.Strength), Microsoft.Xna.Framework.Color.Yellow, Microsoft.Xna.Framework.Color.Black, GameWindow)
        DrawText(PetStatX + 65, PetStatY + 65, "Endurance: " & Player(Myindex).Pet.Stat(StatType.Endurance), Microsoft.Xna.Framework.Color.Yellow, Microsoft.Xna.Framework.Color.Black, GameWindow)
        DrawText(PetStatX + 65, PetStatY + 80, "Vitality: " & Player(Myindex).Pet.Stat(StatType.Vitality), Microsoft.Xna.Framework.Color.Yellow, Microsoft.Xna.Framework.Color.Black, GameWindow)

        DrawText(PetStatX + 165, PetStatY + 50, "Luck: " & Player(Myindex).Pet.Stat(StatType.Luck), Microsoft.Xna.Framework.Color.Yellow, Microsoft.Xna.Framework.Color.Black, GameWindow)
        DrawText(PetStatX + 165, PetStatY + 65, "Intelligence: " & Player(Myindex).Pet.Stat(StatType.Intelligence), Microsoft.Xna.Framework.Color.Yellow, Microsoft.Xna.Framework.Color.Black, GameWindow)
        DrawText(PetStatX + 165, PetStatY + 80, "Spirit: " & Player(Myindex).Pet.Stat(StatType.Spirit), Microsoft.Xna.Framework.Color.Yellow, Microsoft.Xna.Framework.Color.Black, GameWindow)

        DrawText(PetStatX + 65, PetStatY + 95, "Experience: " & Player(Myindex).Pet.Exp & "/" & Player(Myindex).Pet.Tnl, Microsoft.Xna.Framework.Color.Yellow, Microsoft.Xna.Framework.Color.Black, GameWindow)
    End Sub
