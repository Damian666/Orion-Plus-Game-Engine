...
#Region "Outgoing Packets"
    Friend Sub SendPetBehaviour(index As Integer)
        ...
        buffer.WriteInt32(ClientPacket.CSetBehaviour)
    ...
    Sub SendTrainPetStat(statNum As Byte)
        ...
        buffer.WriteInt32(ClientPacket.CPetUseStatPoint)
    ...
    Sub SendRequestPets()
        ...
        buffer.WriteInt32(ClientPacket.CRequestPets)
    ...
    Sub SendUsePetSkill(skill As Integer)
        ...
        buffer.WriteInt32(ClientPacket.CPetSkill)
    ...
    Sub SendSummonPet()
        ...
        buffer.WriteInt32(ClientPacket.CSummonPet)
    ...
    Sub SendReleasePet()
        ...
        buffer.WriteInt32(ClientPacket.CReleasePet)
...
#Region "Movement"
    ...
    Friend Sub PetMove(x As Integer, y As Integer)
        ...
        buffer.WriteInt32(ClientPacket.CPetMove)
...
#Region "Drawing"
    ...
    Friend Sub DrawPlayerPetName(index As Integer)
        ...
        name = GetPlayerName(index).Trim & "'s " & Pet(Player(index).Pet.Num).Name.Trim
        ' calc pos
    ...
    Sub DrawPetStats()
        ...
        Dim petname As String = Pet(Player(Myindex).Pet.Num).Name.Trim
...
#End Region
    ...
    Friend Sub PetEditorInit()
        ...
        With frmPet
            ...
            Next
            .txtName.Text = Pet(EditorIndex).Name.Trim
