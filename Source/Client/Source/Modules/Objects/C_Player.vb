...
#Region "Data Set & Retrieval"
    ...
    Function GetPlayerInvItemNum(index As Integer, invslot As Integer) As Integer
        ...
        GetPlayerInvItemNum = PlayerInv(invslot).Index
    End Function
    ...
    Sub SetPlayerInvItemNum(index As Integer, invslot As Integer, itemnum As Integer)
        If index > MAX_PLAYERS Then Exit Sub
        PlayerInv(invslot).Index = itemnum
    End Sub

    Function GetPlayerInvItemValue(index As Integer, invslot As Integer) As Long
        If index > MAX_PLAYERS Then Return 0
        Return PlayerInv(invslot).Amount
    End Function

    Sub SetPlayerInvItemValue(index As Integer, invslot As Integer, itemValue As Integer)
        If index > MAX_PLAYERS Then Exit Sub
        PlayerInv(invslot).Amount = itemValue
    End Sub
...
#Region "Drawing"
    ...
    Sub DrawEquipment()
        ...
        Dim tempRarityColor As Microsoft.Xna.Framework.Color
        ...
        For i = 1 To EquipmentType.Count - 1
            ...
            If itemnum > 0 Then
                ...
                ItemsSprite(itempic).Position = New Vector2(recPos.X, recPos.Y)
                ...
                Dim rec2 As New RectangleShape With {
                    .OutlineColor = New Microsoft.Xna.Framework.Color(tempRarityColor),
                    .OutlineThickness = 2,
                    .FillColor = New Microsoft.Xna.Framework.Color(Microsoft.Xna.Framework.Color.Transparent),
                    .Size = New Vector2(30, 30),
                    .Position = New Vector2(recPos.X, recPos.Y)
                }
        ...
        'name
        DrawText(CharWindowX + 10, CharWindowY + 14, Language.Character.name & GetPlayerName(Myindex), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
        'class
        DrawText(CharWindowX + 10, CharWindowY + 33, Language.Character.ClassType & Trim(Classes(GetPlayerClass(Myindex)).Name), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
        'level
        DrawText(CharWindowX + 150, CharWindowY + 14, Language.Character.Level & GetPlayerLevel(Myindex), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
        'points
        DrawText(CharWindowX + 6, CharWindowY + 200, Language.Character.Points & GetPlayerPoints(Myindex), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)

        'Header
        DrawText(CharWindowX + 250, CharWindowY + 14, Language.Character.StatsLabel, Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)

        'strength stat
        DrawText(CharWindowX + 210, CharWindowY + 30, Language.Character.Strength & GetPlayerStat(Myindex, StatType.Strength), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 11)
        'endurance stat
        DrawText(CharWindowX + 210, CharWindowY + 50, Language.Character.endurance & GetPlayerStat(Myindex, StatType.Endurance), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 11)
        'vitality stat
        DrawText(CharWindowX + 210, CharWindowY + 70, Language.Character.Vitality & GetPlayerStat(Myindex, StatType.Vitality), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 11)
        'intelligence stat
        DrawText(CharWindowX + 210, CharWindowY + 90, Language.Character.intelligence & GetPlayerStat(Myindex, StatType.Intelligence), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 11)
        'luck stat
        DrawText(CharWindowX + 210, CharWindowY + 110, Language.Character.Luck & GetPlayerStat(Myindex, StatType.Luck), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 11)
        'spirit stat
        DrawText(CharWindowX + 210, CharWindowY + 130, Language.Character.spirit & GetPlayerStat(Myindex, StatType.Spirit), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 11)
