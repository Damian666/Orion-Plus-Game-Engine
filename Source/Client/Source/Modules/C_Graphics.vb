...
NextLoop:
    ...
    Friend Sub EditorNpc_DrawSprite()
        ...
        If File.Exists(Environment.CurrentDirectory & GFXPATH & "characters\" & Sprite & GFXEXT) Then
            frmNPC.picSprite.Width = Drawing.Image.FromFile(Environment.CurrentDirectory & GFXPATH & "characters\" & Sprite & GFXEXT).Width / 4
            frmNPC.picSprite.Height = Drawing.Image.FromFile(Environment.CurrentDirectory & GFXPATH & "characters\" & Sprite & GFXEXT).Height / 4
            frmNPC.picSprite.BackgroundImage = Drawing.Image.FromFile(Environment.CurrentDirectory & GFXPATH & "characters\" & Sprite & GFXEXT)
        End If
    End Sub
      ...
      Friend Sub EditorResource_DrawSprite()
        ...
        Else
            If File.Exists(Environment.CurrentDirectory & GFXPATH & "resources\" & Sprite & GFXEXT) Then
                frmResource.picNormalpic.BackgroundImage = Drawing.Image.FromFile(Environment.CurrentDirectory & GFXPATH & "resources\" & Sprite & GFXEXT)
            End If
        End If
        ...
        Else
            If File.Exists(Environment.CurrentDirectory & GFXPATH & "resources\" & Sprite & GFXEXT) Then
                frmResource.picExhaustedPic.BackgroundImage = Drawing.Image.FromFile(Environment.CurrentDirectory & GFXPATH & "resources\" & Sprite & GFXEXT)
            End If
        End If
    End Sub
