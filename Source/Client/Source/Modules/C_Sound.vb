...
Module C_Sound
    ...
    Sub PlayMusic(fileName As String)
        If Configuration.Settings.Music = 0 OrElse Not File.Exists(Environment.CurrentDirectory & MusicPath & fileName) Then Exit Sub
        If fileName = CurMusic Then Exit Sub

        If MusicPlayer Is Nothing Then
            Try
                MusicPlayer = New Music(Environment.CurrentDirectory & MusicPath & fileName)
    ...
    Sub PlayPreview(fileName As String)
        ...
        If PreviewPlayer Is Nothing Then
            Try
                PreviewPlayer = New Music(Environment.CurrentDirectory & MusicPath & fileName)
    ...
    Sub PlaySound(fileName As String, Optional looped As Boolean = False)
        If Configuration.Settings.Sound = 0 OrElse Not File.Exists(Environment.CurrentDirectory & SoundPath & fileName) Then Exit Sub

        Dim buffer As SoundBuffer
        If SoundPlayer Is Nothing Then
            SoundPlayer = New Sound()
            buffer = New SoundBuffer(Environment.CurrentDirectory & SoundPath & fileName)
