    ...
    Friend Sub DrawQuestLog()
        ...
        For i = 1 To MaxActivequests
            If Len(Trim$(QuestNames(i))) > 0 Then
                DrawText(QuestLogX + 7, QuestLogY + y, Trim$(QuestNames(i)), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
                y = y + 20
            End If
        Next
        ...
        For Each str As String In WordWrap(Trim$(QuestTaskLogText), 35, WrapMode.Characters, WrapType.BreakWord)
            'description
            DrawText(QuestLogX + 204, QuestLogY + 30 + y, str, Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
            y = y + 15
        Next
        ...
        For Each str As String In WordWrap(Trim$(ActualTaskText), 40, WrapMode.Characters, WrapType.BreakWord)
            'description
            DrawText(QuestLogX + 204, QuestLogY + 147 + y, str, Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
            y = y + 15
        Next
        ...
        For Each str As String In WordWrap(Trim$(QuestDialogText), 40, WrapMode.Characters, WrapType.BreakWord)
            'description
            DrawText(QuestLogX + 204, QuestLogY + 218 + y, str, Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
            y = y + 15
        Next
        DrawText(QuestLogX + 280, QuestLogY + 263, Trim$(QuestStatus2Text), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)

        'DrawText(QuestLogX + 285, QuestLogY + 288, Trim$(QuestRequirementsText), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)

        y = 0
        For i = 1 To QuestRewardsText.Length - 1
            'description
            DrawText(QuestLogX + 255, QuestLogY + 292 + y, Trim$(QuestRewardsText(i)), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
            y = y + 15
        Next
