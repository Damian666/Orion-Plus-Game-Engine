    ...
    Friend Sub DrawCraftPanel()
        ...
        For i = 1 To MAX_RECIPE
            If Len(Trim$(RecipeNames(i))) > 0 Then
                DrawText(CraftPanelX + 12, CraftPanelY + y, Trim$(RecipeNames(i)), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
                y = y + 20
            End If
        Next
        ...
        DrawText(CraftPanelX + 367, CraftPanelY + 418, Trim$(CraftAmountValue), Microsoft.Xna.Framework.Color.Black, Microsoft.Xna.Framework.Color.White, GameWindow)
        ...
        If PicProductindex > 0 Then
            ...
            DrawText(CraftPanelX + 310, CraftPanelY + 20, Trim$(LblProductNameText), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)

            DrawText(CraftPanelX + 310, CraftPanelY + 35, Trim$(LblProductAmountText), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
        End If
        ...
        For i = 1 To MAX_INGREDIENT
            If PicMaterialIndex(i) > 0 Then
                ...
                DrawText(CraftPanelX + 315, CraftPanelY + y, Trim$(LblMaterialName(i)), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)

                DrawText(CraftPanelX + 315, CraftPanelY + y + 15, Trim$(LblMaterialAmount(i)), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
