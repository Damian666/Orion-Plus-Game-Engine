...
#Region "Drawing"
    ...
    Friend Sub DrawParty()
        ...
        If Party.Leader > 0 Then ' make sure we're in a party
            ...
            y = 100
            x = 10
            DrawText(x, y, theName, Microsoft.Xna.Framework.Color.Yellow, Microsoft.Xna.Framework.Color.Black, GameWindow)
            ...
            If Player(playerNum).Vital(VitalType.HP) > 0 Then
                ...
                Dim rectShape As New RectangleShape(New Vector2(barwidth, 6)) With {
                    .Position = New Vector2(x, y + 15),
            ...
            If Player(playerNum).Vital(VitalType.MP) > 0 Then
                ...
                ' draw bars
                rec(1) = New Rectangle(x, y, barwidth, 6)
                Dim rectShape2 As New RectangleShape(New Vector2(barwidth, 6)) With {
                    .Position = New Vector2(x, y + 24),
            ...
            For I = 1 To MAX_PARTY_MEMBERS
                If Party.Member(I) > 0 Then
                    If Party.Member(I) <> Party.Leader Then
                        ...
                        DrawText(x, y, theName, Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow)
                        ' draw hp
                        y = 115 + ((I - 1) * 30)
