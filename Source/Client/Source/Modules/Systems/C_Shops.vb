...
#Region "Drawing"
    ...
    Sub DrawShop()
        ...
        'draw text
        DrawText(ShopWindowX + ShopLeft, ShopWindowY + 10, Trim(Shop(InShop).Name), Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 15)

        DrawText(ShopWindowX + 10, ShopWindowY + 10, "Hello, and welcome", Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 15)
        DrawText(ShopWindowX + 10, ShopWindowY + 25, "to the shop!", Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 15)
