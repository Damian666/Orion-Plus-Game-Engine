...
#Region "Incoming Packets"
    ...
    Sub Packet_TradeUpdate(ByRef data() As Byte)
        ...
        If datatype = 0 Then ' ours!
            For i = 1 To MAX_INV
                TradeYourOffer(i).Index = buffer.ReadInt32
                TradeYourOffer(i).Amount = buffer.ReadInt32
            Next
            YourWorth = String.Format(Language.Trade.Value, buffer.ReadInt32) & "g"
        ElseIf datatype = 1 Then 'theirs
            For i = 1 To MAX_INV
                TradeTheirOffer(i).Index = buffer.ReadInt32
                TradeTheirOffer(i).Amount = buffer.ReadInt32
            Next
...
#Region "Drawing"
    ...
    Sub DrawTrade()
        ...
        Dim colour As Microsoft.Xna.Framework.Color
        ...
        'Headertext
        DrawText(TradeWindowX + 70, TradeWindowY + 6, "Your Offer", Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 15)

        DrawText(TradeWindowX + 260, TradeWindowY + 6, Tradername & "'s Offer.", Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 15)

        For i = 1 To MAX_INV
            ' blt your own offer
            itemnum = GetPlayerInvItemNum(Myindex, TradeYourOffer(i).Index)
            ...
            If itemnum > 0 AndAlso itemnum <= MAX_ITEMS Then
                ...
                If itempic > 0 AndAlso itempic <= NumItems Then
                    ...
                    If TradeYourOffer(i).Amount >= 1 Then
                        y = recPos.Top + 22
                        x = recPos.Left - 4
                        ...
                        ElseIf amount > 10000000 Then
                            colour = Microsoft.Xna.Framework.Color.Green
                        End If

                        amount = TradeYourOffer(i).Amount
                        DrawText(x, y, ConvertCurrency(amount), colour, Microsoft.Xna.Framework.Color.Black, GameWindow)
                    End If
                End If
            End If
        Next

        DrawText(TradeWindowX + 8, TradeWindowY + 288, YourWorth, Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 13)

        For i = 1 To MAX_INV
            ' blt their offer
            itemnum = TradeTheirOffer(i).Index
            ...
            If itemnum > 0 AndAlso itemnum <= MAX_ITEMS Then
                ...
                If itempic > 0 AndAlso itempic <= NumItems Then
                    ...
                    If TradeTheirOffer(i).Amount >= 1 Then
                        y = recPos.Top + 22
                        x = recPos.Left - 4
                        ...
                        amount = TradeTheirOffer(i).Amount
                        DrawText(x, y, amount, colour, Microsoft.Xna.Framework.Color.Black, GameWindow)
                    End If
                End If
            End If
        Next

        DrawText(TradeWindowX + 208, TradeWindowY + 288, TheirWorth, Microsoft.Xna.Framework.Color.White, Microsoft.Xna.Framework.Color.Black, GameWindow, 13)
