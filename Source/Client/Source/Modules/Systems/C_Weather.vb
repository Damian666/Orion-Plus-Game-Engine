...
#Region "Drawing"
    ...
    Friend Sub DrawThunderEffect()
        ...
        If DrawThunder > 0 Then
            ...
            tmpSprite = New Sprite(New Texture(New SFML.Graphics.Image(GameWindow.Size.X, GameWindow.Size.Y, Microsoft.Xna.Framework.Color.White))) With {
    ...
    Friend Sub DrawFog()
        ...
        FogSprite(fogNum).Position = New Vector2((FogOffsetX * 2.5) - 50, (FogOffsetY * 3.5) - 50)
        FogSprite(fogNum).Scale = (New Vector2(CDbl((GameWindow.Size.X + 200) / FogGfxInfo(fogNum).Width), CDbl((GameWindow.Size.Y + 200) / FogGfxInfo(fogNum).Height)))
