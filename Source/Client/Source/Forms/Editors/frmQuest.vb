...
Friend Class frmQuest
    ...
    Private Sub TxtName_TextChanged(sender As Object, e As EventArgs) Handles txtName.TextChanged
        ...
        Quest(Editorindex).Name = txtName.Text.Trim
...
#Region "Tasks"
    ...
    Private Sub BtnSaveTask_Click(sender As Object, e As EventArgs) Handles btnSaveTask.Click
        ...
        Quest(Editorindex).Task(SelectedTask).TaskLog = txtTaskLog.Text.Trim
