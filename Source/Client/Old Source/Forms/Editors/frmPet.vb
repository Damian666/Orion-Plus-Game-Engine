...
#Region "Basics"
    ...
    Private Sub TxtName_TextChanged(sender As Object, e As EventArgs) Handles txtName.TextChanged
        ...
        Pet(Editorindex).Name = txtName.Text.Trim
    ...
    Friend Sub EditorPet_DrawPet()
        ...
        If File.Exists(Environment.CurrentDirectory & GfxPath & "Characters\" & petnum & GfxExt) Then
            picSprite.BackgroundImage = Image.FromFile(Environment.CurrentDirectory & GfxPath & "Characters\" & petnum & GfxExt)
        End If
