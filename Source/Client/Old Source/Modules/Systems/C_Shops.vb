...
#Region "Outgoing Packets"
    ...
    Friend Sub BuyItem(shopslot As Integer)
        ...
        buffer.WriteInt32(ClientPacket.CBuyItem)
    ...
    Friend Sub SellItem(invslot As Integer)
        ...
        buffer.WriteInt32(ClientPacket.CSellItem)
...
#Region "Drawing"
    ...
    Sub DrawShop()
        ...
        'draw text
        DrawText(ShopWindowX + ShopLeft, ShopWindowY + 10, Shop(InShop).Name.Trim, SFML.Graphics.Color.White, SFML.Graphics.Color.Black, GameWindow, 15)
