...
newlist:
    ...
    Sub AddCommand(ByVal Index As Integer)
        ...
        Select Case Index
            ...
            Case EventType.EvPlayBgm
                TmpEvent.Pages(CurPageNum).CommandList(curlist).Commands(curslot).Index = Index
                TmpEvent.Pages(CurPageNum).CommandList(curlist).Commands(curslot).Text1 = Audio.Music(FrmEditor_Events.cmbPlayBGM.SelectedIndex + 1)
            ...
            Case EventType.EvPlaySound
                TmpEvent.Pages(CurPageNum).CommandList(curlist).Commands(curslot).Index = Index
                TmpEvent.Pages(CurPageNum).CommandList(curlist).Commands(curslot).Text1 = Audio.Sound(FrmEditor_Events.cmbPlaySound.SelectedIndex + 1)
        ...
        Select Case TmpEvent.Pages(CurPageNum).CommandList(curlist).Commands(curslot).Index
            ...
            Case EventType.EvPlayBgm
                ...
                for each n In Audio.Music
                    If n = TmpEvent.Pages(CurPageNum).CommandList(curlist).Commands(curslot).Text1 Then
...
#Region "Drawing..."
    ...
    Public Sub EditorEvent_DrawGraphic()
        ...
        Dim g As System.Drawing.Graphics 'This is our graphics class that helps us draw to the targetBitmap
