...
#Region "Incoming Packets"
    ...
    Sub Packet_PartyInvite(ByRef data() As Byte)
        ...
        DialogMsg2 = name.Trim & " has invited you to a party. Would you like to join?"
...
#Region "Outgoing Packets"
    ...
    Friend Sub SendPartyRequest(name As String)
        ...
        buffer.WriteInt32(ClientPacket.CRequestParty)
    ...
    Friend Sub SendAcceptParty()
        ...
        buffer.WriteInt32(ClientPacket.CAcceptParty)
    ...
    Friend Sub SendDeclineParty()
        ...
        buffer.WriteInt32(ClientPacket.CDeclineParty)
    ...
    Friend Sub SendLeaveParty()
        ...
        buffer.WriteInt32(ClientPacket.CLeaveParty)
    ...
    Friend Sub SendPartyChatMsg(text As String)
        ...
        buffer.WriteInt32(ClientPacket.CPartyChatMsg)
...
#Region "Drawing"
    ...
    Friend Sub DrawParty()
        ...
        If Party.Leader > 0 Then ' make sure we're in a party
            ...
            ' name
            theName = GetPlayerName(playerNum).Trim
            ' draw name
            y = 100
            x = 10
