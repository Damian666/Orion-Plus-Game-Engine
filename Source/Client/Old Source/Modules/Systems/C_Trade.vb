...
#Region "Incoming Packets"
    ...
    Sub Packet_TradeInvite(ByRef data() As Byte)
        ...
        DialogMsg1 = String.Format(Configuration.Language.Trade.tradeinvite, (Player(requester).Name).Trim)
    ...
    Sub Packet_Trade(ByRef data() As Byte)
        ...
        buffer.ReadInt32()
        Tradername = buffer.ReadString.Trim
    ...
    Sub Packet_TradeUpdate(ByRef data() As Byte)
        ...
        If datatype = 0 Then ' ours!
            ...
            Next
            YourWorth = String.Format(Configuration.Language.Trade.tradeworth, buffer.ReadInt32)
    ...
    Sub Packet_TradeStatus(ByRef data() As Byte)
        ...
        Select Case tradestatus
            ...
            Case 1 ' they've accepted
                AddText(Configuration.Language.Trade.tradestatusok, ColorType.White)
            Case 2 ' you've accepted
                AddText(Configuration.Language.Trade.tradestatuswait, ColorType.White)
        End Select
...
#Region "Outgoing Packets"
    ...
    Friend Sub AcceptTrade()
        ...
        buffer.WriteInt32(ClientPacket.CAcceptTrade)
    ...
    Friend Sub DeclineTrade()
        ...
        buffer.WriteInt32(ClientPacket.CDeclineTrade)
    ...
    Sub SendTradeRequest(name As String)
        ...
        buffer.WriteInt32(ClientPacket.CTradeInvite)
    ...
    Sub SendTradeInviteAccept(awnser As Byte)
        ...
        buffer.WriteInt32(ClientPacket.CTradeInviteAccept)
    ...
    Friend Sub TradeItem(invslot As Integer, amount As Integer)
        ...
        buffer.WriteInt32(ClientPacket.CTradeItem)
    ...
    Friend Sub UntradeItem(invslot As Integer)
        ...
        buffer.WriteInt32(ClientPacket.CUntradeItem)
        buffer.WriteInt32(invslot)
